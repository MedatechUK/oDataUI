...
namespace ScintillaNET.Demo {
	public partial class MainForm : Form {
		...
		private void MainForm_Load(object sender, EventArgs e) {
            ...
            autocompleteMenu1.TargetControlWrapper = new ScintillaWrapper(TextArea);
            ...
            //TextArea.Lines[TextArea.CurrentLine].Text.Length 
		...
		private void InitSyntaxColoring() {
			...
			//TextArea.Styles[Style.Json.Tag].ForeColor = Color.Blue;
			//TextArea.Styles[Style.Json.Attribute].ForeColor = Color.Red;
			//TextArea.Styles[Style.Json.Number].ForeColor = Color.Pink;
			//TextArea.Styles[Style.Json.SingleString].ForeColor = Color.FromArgb(128, 0, 255);
			//TextArea.Styles[Style.Json.DoubleString].ForeColor = Color.FromArgb(128, 0, 255);
			//TextArea.Styles[Style.Json.Comment].ForeColor = Color.Green;
			//TextArea.Styles[Style.Json.Start].ForeColor = Color.Red;
			//TextArea.Styles[Style.Json.End].ForeColor = Color.Red;

			//TextArea.SetSelectionForeColor(Color.Black);
			//TextArea.SetSelectionBackColor(Color.Gray);

			TextArea.Styles[Style.Json.Default].ForeColor = Color.Blue;			
			...
			TextArea.Styles[Style.Json.Keyword].ForeColor = Color.FromArgb(163, 21, 21);
			TextArea.Styles[Style.Json.PropertyName].ForeColor = Color.FromArgb(46, 117, 182);
			TextArea.Styles[Style.Json.String].ForeColor = Color.Red;
			TextArea.Styles[Style.Json.Uri].ForeColor = Color.Blue;
